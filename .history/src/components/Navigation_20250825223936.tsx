...
export default function Navigation() {
  ...
  const MenuContainer: React.FC<{
    ...
    <li
      className="relative"
      onMouseEnter={() => setOpen(k)}   // HOVER OPENS
      onMouseLeave={() => setOpen(null)} // HOVER LEAVES -> CLOSE
    >
      {/* Trigger: no onClick -> doesn't toggle by click */}
      <div
        ...
        tabIndex={0}
        onFocus={() => setOpen(k)} // focus from keyboard also opens
        onBlur={(e) => {
          // close only if focus left the whole li (incl. submenu)
  ...
  // Clicking an item navigates and the useEffect above closes the menu
  // immediately on route change. We also close instantly for snappy UX.
      ...
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <ul className="flex gap-6 text-sm md:text-base font-medium items-center">
          ...
          <MenuContainer label="Fleet" k="fleet">
            <li role="none">
              <Link href="/party-buses" className={itemCls} role="menuitem" onClick={closeNow}>
                Party Buses
              </Link>
            </li>
            <li role="none">
              <Link href="/limousines" className={itemCls} role="menuitem" onClick={closeNow}>
                Limousines
              </Link>
            </li>
            <li role="none">
              <Link href="/coach-buses" className={itemCls} role="menuitem" onClick={closeNow}>
                Coach Buses
              </Link>
            </li>
          </MenuContainer>
          ...
          <MenuContainer label="Resources" k="resources">
            <li role="none">
              <Link href="/blog" className={itemCls} role="menuitem" onClick={closeNow}>Blog</Link>
            </li>
            <li role="none">
              <Link href="/tools" className={itemCls} role="menuitem" onClick={closeNow}>Tools</Link>
            </li>
            <li role="none">
              <Link href="/industry-secrets" className={itemCls} role="menuitem" onClick={closeNow}>Industry Secrets</Link>
            </li>
            <li role="none">
              <Link href="/poll-results" className={itemCls} role="menuitem" onClick={closeNow}>Poll Results</Link>
            </li>
            <li role="none">
              <Link href="/reviews" className={itemCls} role="menuitem" onClick={closeNow}>Reviews</Link>
            </li>
          </MenuContainer>
