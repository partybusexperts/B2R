...
export default function RoutePlanner() {
  ...
  async function handlePlan(e: React.FormEvent) {
    ...
    try {
      ...
      if (!json.ok || !json.data) setError(json.error || "Could not plan that route.");
      else setRoute(json.data);
    } catch (err) {
  ...
  return (
    <div className="p-4 max-w-3xl mx-auto">
      ...
      <div className="text-xs text-gray-500 mt-4">
        Powered by <a href="https://openrouteservice.org/" className="underline" target="_blank" rel="noopener noreferrer">OpenRouteService</a>
      </div>
    </div>
  );
}
