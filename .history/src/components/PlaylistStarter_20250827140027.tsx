      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
        {playlists.map(pl => (
          <div key={pl.id} className="bg-white rounded-xl shadow p-3 flex flex-col items-center border border-blue-200">
            {pl.image ? (
              <SmartImage src={pl.image} alt={pl.name} className="w-20 h-20 rounded-lg mb-2 object-cover border-2 border-blue-100" />
            ) : (
              <div className="w-20 h-20 mb-2 rounded-lg border-2 border-blue-100 bg-gradient-to-br from-blue-200 to-blue-300 flex items-center justify-center text-2xl text-blue-700 font-bold">
