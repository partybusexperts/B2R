    ...
    try {
      ...
      const mapped: PlaylistMeta[] = PLAYLIST_PRESETS.map((p) => {
        ...
        return {
          ...
          image: live?.image,
          // ALWAYS ensure a usable URL (even if live missing)
          url: live?.url || `https://open.spotify.com/playlist/${p.id}`,
          live: !!live,
        };
      });
          ...
          return (
            <div key={pl.id} className="bg-white rounded-xl shadow p-3 flex flex-col items-center border border-blue-200 relative">
              ...
              <div className="flex flex-col w-full gap-1">
                ...
                {isPreset && !pl.live && <div className="text-[10px] text-blue-700 text-center">(Loading live data…)</div>}
