...
function PollCard({ poll, onGlobalShare }: { poll: Poll; onGlobalShare: (embed: string) => void }) {
  ...
  const embedCode = (() => {
    ...
    return `<iframe src="${window.location.origin}/embed/poll/${id}" width="100%" height="420" style="border:0;border-radius:12px;overflow:hidden" loading="lazy" referrerpolicy="no-referrer"></iframe>`;
  })();
