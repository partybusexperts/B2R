...
export default function ToolsGrid({ className, limit, filter }: { className?: string; limit?: number; filter?: string }) {
  ...
  return (
    <div className={className}>
      ...
      {openIdx !== null && candidates[openIdx] && (
        <Modal open={true} onClose={closeTool} title={candidates[openIdx].title}>
