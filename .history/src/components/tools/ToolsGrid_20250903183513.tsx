        ...
        <Modal open={true} onClose={closeTool} title={candidates[openIdx].title} sizeClass={modalSizeFor(candidates[openIdx])}>
          <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <div className="text-sm text-slate-600">Embed on your site: <a className="text-blue-600 underline" href={`${typeof window !== 'undefined' ? window.location.origin : ''}/tools/${candidates[openIdx].id}`} target="_blank" rel="noreferrer">{typeof window !== 'undefined' ? window.location.origin : ''}/tools/{candidates[openIdx].id}</a></div>
            </div>
