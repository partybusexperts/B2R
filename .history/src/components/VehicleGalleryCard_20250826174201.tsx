...
export const VehicleGalleryCard: React.FC<Props> = ({ vehicle, phoneTel='8885352566', email='info@bus2ride.com', showCTA=true, autoRotateMs=4500 }) => {
  ...
  return (
    <div className="bg-[#15305f]/90 border border-blue-800/40 rounded-[24px] shadow-[0_10px_30px_rgba(2,6,23,.35)] overflow-hidden group">
      ...
      <div className="px-6 mt-3">
        <div className="relative h-80 md:h-[22rem] w-full overflow-hidden rounded-2xl border border-blue-800/30 bg-[#18356e] flex items-center justify-center">
          {active?.entry ? (
            <OptimizedImage
              entry={active.entry}
      ...
      <div className="px-6 mt-5">
        <h3 className="text-xl md:text-2xl font-extrabold text-white tracking-tight text-center">{vehicle.name}</h3>
