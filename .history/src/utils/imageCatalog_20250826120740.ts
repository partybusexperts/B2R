...
export const imageCatalog: Record<VehicleCategory, VehicleImage[]> = {
  partyBuses: [
    ...
    { file: "/images/party-buses/bus-none.png", alt: "Party Bus placeholder" },
    { file: "/images/party-buses/Bus-None2.png", alt: "Party Bus placeholder 2" },
    { file: "/images/party-buses/Bus-None3.png", alt: "Party Bus placeholder 3" },
    { file: "/images/party-buses/Bus-None4.png", alt: "Party Bus placeholder 4" }
  ],
  limousines: [
    ...
    { file: "/images/limousines/10 Passenger Lincoln Stretch Inside.png", alt: "10 Passenger Lincoln Stretch limo inside" },
  ...
  coachBuses: [
    // No dedicated coach bus images yet (placeholders originally mixed in party-buses folder)
  ],
  sprinters: [
    { file: "/images/limousines/10 Passenger Sprinter Van Limo Style Interior 1.png", alt: "10 passenger sprinter limo style interior" },
    { file: "/images/sprinters/12 Passenger Executive Style Sprinter Van Exterior.png", alt: "12 passenger executive sprinter exterior" },
    { file: "/images/limousines/14 Passenger Sprinter Van Limo Style Exterior Door Open.png", alt: "14 passenger sprinter limo style exterior door open" },
    { file: "/images/limousines/14 Passenger Sprinter Van Limo Style Interior Again.png", alt: "14 passenger sprinter limo style interior" }
  ],
  executiveSprinters: [
    { file: "/images/sprinters/12 Passenger Executive Style Sprinter Van Exterior.png", alt: "12 passenger executive sprinter exterior" }
  ]
