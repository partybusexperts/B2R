...
export const imageCatalog: Record<VehicleCategory, VehicleImage[]> = {
  ...
  coachBuses: [
    { file: "/images/coach-buses/Bus-None2.png", alt: "Coach bus placeholder" },
    { file: "/images/coach-buses/Bus-None3.png", alt: "Coach bus placeholder 2" },
    { file: "/images/coach-buses/Bus-None4.png", alt: "Coach bus placeholder 3" },
    { file: "/images/coach-buses/bus-none.png", alt: "Coach bus placeholder 4" }
  ],
  sprinters: [
    { file: "/images/sprinters/10 Passenger Sprinter Van Limo Style Interior 1.png", alt: "10 passenger sprinter limo style interior" },
    ...
    { file: "/images/sprinters/14 Passenger Sprinter Van Limo Style Exterior Door Open.png", alt: "14 passenger sprinter limo style exterior door open" },
    { file: "/images/sprinters/14 Passenger Sprinter Van Limo Style Interior Again.png", alt: "14 passenger sprinter limo style interior" }
  ],
  executiveSprinters: [
