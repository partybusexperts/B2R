...
// Keep specific vehicle models but avoid duplicating broader type categories (limo, suv, party)
export const VEHICLE_CATEGORIES: PollCategory[] = [
  { key: "vehicle:sprinter", label: "Sprinter Van", group: "vehicles", synonyms: ["mercedes sprinter", "sprinter limo"] },
