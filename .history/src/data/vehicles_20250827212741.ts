...
export const VEHICLES: VehicleSpec[] = [
  ...
  // Limo style sprinters added into party-buses grouping
  {
    ...
    capacityMin: 10,
    capacityMax: 10,
    highlights: ['Luxury interior', 'LED lighting', 'Bluetooth audio'],
    images: [
      { file: '10 Passenger Limo Sprinter Exterior.png', role: 'exterior', primary: true, alt: '10 passenger limo style sprinter exterior' },
      { file: '10 Passenger Sprinter Van Limo Style Interior 1.png', role: 'interior', alt: '10 passenger limo style sprinter interior seating and lighting' }
    ],
  order: 15
  },
  {
    ...
    capacityMin: 12,
    capacityMax: 12,
    highlights: ['Wrap seating', 'Bar area', 'Mood LEDs'],
    images: [
      { file: '12 Passenger Sprinter Limo Exterior.png', role: 'exterior', primary: true, alt: '12 passenger limo style sprinter exterior' },
      { file: '12 Passenger Limo Style Sprinter Interior.png', role: 'interior', alt: '12 passenger limo style sprinter interior seating and lighting' }
    ],
    order: 18
  },
  ...
  {
    id: 'limo-lincoln-10',
    name: '10 Passenger Lincoln Stretch Limousine',
    category: 'limousines',
    capacityMin: 10,
    capacityMax: 10,
  ...
  },
  {
    ...
    name: '10 Passenger Chrysler Limousine',
    category: 'limousines',
    capacityMin: 10,
    capacityMax: 10,
  ...
  },
  {
    ...
    name: '10 Passenger Chrysler 300 Limo',
    category: 'limousines',
    capacityMin: 10,
    capacityMax: 10,
  ...
  {
    id: 'limo-chrysler-12',
    name: '12 Passenger Chrysler Limo',
    category: 'limousines',
    capacityMin: 12,
    capacityMax: 12,
  ...
  },
  {
    ...
    name: '18 Passenger Excursion Limo',
    category: 'limousines',
    capacityMin: 18,
    capacityMax: 18,
    highlights: ['Maximum wow factor', 'Disco ceiling', 'Ice Wells'],
  ...
  // Executive Sprinters (grouped under coach-buses for now per request)
  {
    ...
    capacityMin: 8,
    capacityMax: 8,
    highlights: ['Executive seating', 'High roof', 'USB charging'],
    images: [
      { file: '8 Passenger Executive Sprinter Van Exterior.png', role: 'exterior', primary: true, alt: '8 passenger executive sprinter exterior' },
      { file: '8 Passenger Executive Sprinter Van Interior.png', role: 'interior', alt: '8 passenger executive sprinter interior leather seating' }
    ],
    order: 1
  },
  {
    ...
    highlights: ['Executive seating', 'High roof', 'USB charging'],
    images: [
  { file: '10 Passenger Executive Sprinter Van.png', role: 'exterior', primary: true, alt: '10 passenger executive sprinter exterior' },
  { file: '10 Passenger Executive Sprinter.png', role: 'interior', alt: '10 passenger executive sprinter interior' }
    ],
    order: 2
  },
  {
    ...
    highlights: ['Executive seating', 'High roof', 'USB charging'],
    images: [
      { file: '12 Passenger Executive Style Sprinter Van Exterior.png', role: 'exterior', primary: true, alt: '12 passenger executive sprinter exterior' },
      { file: '12 Passenger Executive Sprinter Interior.png', role: 'interior', alt: '12 passenger executive sprinter interior seating' }
    ],
    order: 3
  },
  {
    ...
    highlights: ['Executive seating', 'High roof', 'USB charging'],
    images: [
      { file: '13 Passenger Executive Sprinter.png', role: 'exterior', primary: true, alt: '13 passenger executive sprinter exterior' },
      { file: '13 Passenger Executive Sprinter Interior.png', role: 'interior', alt: '13 passenger executive sprinter interior seating' }
    ],
    order: 4
  },
  {
    id: 'coach-mini-47',
    name: '28 Passenger Mini Coach',
    category: 'coach-buses',
    capacityMin: 47,
    capacityMax: 47,
    highlights: ['Forward seating', 'Comfort ride', 'Great for tours'],
    images: [
      { file: '47 Passenger Party Bus.png', role: 'exterior', primary: true, alt: 'Mini coach representative exterior' },
      { file: '47 Passenger Coach Bus Interior.png', role: 'interior', alt: 'Mini coach representative interior seating rows' }
    ],
    order: 10
  },
  {
    ...
    images: [
      { file: '56 Passenger Coach Bus Exterior.png', role: 'exterior', primary: true, alt: 'Coach bus exterior (representative)' },
      { file: '56 Passenger Coach Bus Interior Leather.png', role: 'interior', alt: 'Coach bus interior leather seating' }
    ],
    order: 20
  },
  {
    id: 'coach-full-56',
    name: '56 Passenger Full Size Coach',
    category: 'coach-buses',
    capacityMin: 56,
    capacityMax: 56,
    highlights: ['Restroom', 'Luggage bays', 'PA system'],
    images: [
      { file: '56 Passenger Coach Bus Exterior.png', role: 'exterior', primary: true, alt: '56 passenger coach bus exterior' },
      { file: '56 Passenger Coach Bus Interior Leather.png', role: 'interior', alt: '56 passenger coach bus interior leather seating' }
    ],
    order: 30
  }
  ,
