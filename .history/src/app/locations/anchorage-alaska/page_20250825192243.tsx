      ...
      <PageLayout gradientFrom="from-blue-950" gradientVia="via-blue-900" gradientTo="to-black" textColor="text-white">
        ...
        <Section className="max-w-7xl mx-auto -mt-4 bg-gradient-to-br from-blue-900/80 to-black rounded-3xl shadow-xl border border-blue-500/30 py-12 px-6 mb-16">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-[#132a55] rounded-2xl p-6 border border-blue-700/40 shadow flex flex-col gap-2">
              <div className="text-sm tracking-widest text-blue-300 font-semibold">PEAK DEMAND</div>
              <div className="text-2xl font-extrabold">May–Sept (Cruise + Tours)</div>
              <p className="text-blue-100/90 text-sm">Book popular Saturdays 90+ days out; winter brings aurora & ski transfers.</p>
            </div>
            <div className="bg-[#132a55] rounded-2xl p-6 border border-blue-700/40 shadow flex flex-col gap-2">
              <div className="text-sm tracking-widest text-blue-300 font-semibold">WINTER LOWS</div>
              <div className="text-2xl font-extrabold">↓ 0°F Typical</div>
              <p className="text-blue-100/90 text-sm">We vet block heaters, tires & emergency kits for cold resiliency.</p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="mt-6 grid sm:grid-cols-2 gap-4">
                {[
                  { t: "Cruise Transfer", d: "Hotel → Whittier / Seward with glacier stop" },
                  { t: "Aurora Charter", d: "Dynamic route pivoting to clearer skies" },
                  { t: "Corporate Shuttle", d: "Multi‑day crew & vendor loops" },
                  { t: "Ski / Alyeska", d: "Group lodge & evening dining shuttle" },
                  { t: "Wedding Guest", d: "Hotel staging + venue return waves" },
                  { t: "Fishing Charter", d: "Cooler + gear capacity planning" }
                ].map(card => (
            ...
            <div>
              ...
              <ul className="space-y-4 text-blue-100/90 leading-relaxed">
                <li><span className="font-semibold text-blue-50">Summer (Midnight Sun):</span> Longer daylight lets you compress multiple scenic stops—still add buffers for cruise disembark surges.</li>
                <li><span className="font-semibold text-blue-50">Shoulder (Apr–May / Sept–Oct):</span> Often 8–15% lower rates; more fleet flexibility for custom timing + photo detours.</li>
                <li><span className="font-semibold text-blue-50">Winter:</span> Prioritize pre‑trip vehicle warm-up, anti‑slip entry mats, and contingency for black ice slowdowns.</li>
                <li><span className="font-semibold text-blue-50">Aurora windows:</span> Keep driver on flexible standby after midnight; we adapt routing to KP index + cloud cover.</li>
                <li><span className="font-semibold text-blue-50">Wildlife:</span> Moose & Dall sheep can reduce average corridor speed—our planning models assume conservative mph vs posted limits.</li>
              </ul>
        ...
        <Section className="max-w-7xl mx-auto bg-gradient-to-br from-[#122a5c] to-[#0f2148] rounded-3xl shadow-xl my-12 py-12 px-6 border border-blue-800/40">
          ...
          <p className="text-blue-100/90 text-center max-w-3xl mx-auto mb-8">Representative 4–6 hour blocks. Real quotes vary by exact pickup window, mileage, season demand, deadhead positioning and special event impact.</p>
          <div className="overflow-x-auto rounded-2xl border border-blue-700/40 bg-[#132a55] shadow-inner">
            <table className="w-full text-left text-sm md:text-base">
              <thead>
                <tr className="text-blue-200/80 border-b border-blue-700/60">
                  <th className="py-3 px-4 font-semibold">Vehicle</th>
                  <th className="py-3 px-4 font-semibold">Hours</th>
                  <th className="py-3 px-4 font-semibold">Est. Block</th>
                  <th className="py-3 px-4 font-semibold">Est. / Person*</th>
                </tr>
              </thead>
              <tbody>
          ...
          <p className="text-[11px] text-blue-300 mt-4">*Per-person assumes comfortable capacity shown; party buses & coaches can seat more than standard comfort counts. Use our <Link href="/quote" className="underline">instant quote</Link> for live pricing.</p>
        </Section>

        {/* POPULAR ROUTES & HOTSPOTS */}
        <Section className="max-w-7xl mx-auto bg-gradient-to-br from-blue-900/80 to-black rounded-3xl shadow-xl border border-blue-500/30 py-14 px-6 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-6">
              {[
                { t: "Hotel → Whittier Cruise", d: "Plan 1 hr 45 min incl. Port tunnel timing + glacier photo stop option." },
                { t: "Airport → Downtown", d: "Typical 15–25 min; add 10–15 in peak cruise arrivals." },
                { t: "Downtown → Alyeska (Girdwood)", d: "~45–55 min; winter storm days can double." },
                { t: "Anchorage Evening Shuttle", d: "Multi‑stop dinner / brewery / nightlife loop w/ staged pickups." },
                { t: "Aurora Flex Charter", d: "Dynamic routing based on KP + cloud layers (Palmer / Wasilla pivot)." },
                { t: "Fishing Transfer", d: "Cooler & gear staging; early AM departure complexity handled." }
              ].map(r => <div key={r.t} className="p-5 rounded-2xl bg-[#132a55] border border-blue-700/40 shadow"><div className="font-bold text-blue-50">{r.t}</div><div className="text-blue-200 text-sm mt-2 leading-snug">{r.d}</div></div>)}
            </div>
            <div className="space-y-8">
              <div>
                ...
                <ul className="grid grid-cols-2 gap-3 text-sm text-blue-100/90">
                  {['Alyeska Resort','Egan Center','Dena’ina Center','Alaska Railroad Depot','Port of Whittier','Seward Harbor','Hilltop / Arctic Valley','Kincaid Park','Hotel Captain Cook','Chugach Overlooks'].map(v=> <li key={v} className="bg-[#122a4c] rounded-lg px-3 py-2 border border-blue-700/40">{v}</li>)}
                </ul>
              </div>
              <div>
                <h3 className="text-2xl font-bold mb-3 font-serif">Neighborhood Coverage</h3>
                <div className="flex flex-wrap gap-2">
                  {anchorageNeighborhoods.map(n => <span key={n} className="rounded-full bg-blue-50/10 border border-blue-500/40 text-blue-100 text-xs font-semibold px-3 py-1">{n}</span>)}
                </div>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside text-blue-100/90 space-y-1 text-sm">
                  <li>+10–15 min per additional pickup / staging stop</li>
                  <li>+30+ min if Seward Hwy weather advisories (snow / ice)</li>
                  <li>+20 min for cruise disembark surge windows</li>
                  <li>+15 min if large luggage & gear loading (fishing / ski)</li>
                  <li>Flexible 60–90 min window for aurora repositioning</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <Section className="max-w-7xl mx-auto bg-gradient-to-br from-[#122a5c] to-[#0f2148] rounded-3xl shadow-xl my-12 py-12 px-6 border border-blue-800/40">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-4">
              {auroraTips.map(t => <div key={t} className="bg-[#132a55] p-4 rounded-xl border border-blue-700/40 text-blue-100/90 text-sm leading-relaxed">{t}</div>)}
            </div>
            <div className="bg-[#132a55] p-6 rounded-2xl border border-blue-700/40 flex flex-col gap-4">
              ...
              <p className="text-blue-100/90 text-sm leading-relaxed">Use our smart advisory to plan clothing layers, hydration, and timing. It blends current Anchorage conditions with seasonal heuristics.</p>
              <LiveWeatherAdvisor />
            </div>
          </div>
        </Section>
        ...
        <Section className="max-w-7xl mx-auto bg-gradient-to-br from-blue-900/80 to-black rounded-3xl shadow-xl border border-blue-500/30 py-14 px-6 mb-16">
          ...
          <div className="flex justify-center mt-10">
            <Link href="/reviews" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-10 py-4 rounded-2xl shadow-xl text-lg transition border border-blue-700">More Reviews</Link>
          </div>
        </Section>

        {/* SUBMIT REVIEW & SLIDESHOW */}
        <Section className="flex flex-col md:flex-row gap-10 max-w-7xl mx-auto bg-gradient-to-br from-[#122a5c] to-[#0f2148] rounded-3xl shadow-xl py-14 px-6 mb-16 border border-blue-800/40">
          <div className="flex-1">
            ...
            <p className="text-blue-100/90 text-sm leading-relaxed mb-4">Submit a review—top local feedback may be featured on this page & social channels. Add optional photos of your vehicle, event or aurora capture.</p>
            <ReviewForm />
          </div>
          <div className="flex-1 md:border-l border-blue-700/40 md:pl-10">
            ...
            <p className="text-blue-100/90 text-sm leading-relaxed mb-4">Upload highlights—our tool instantly renders a shareable slideshow (great for destination recap or event thank‑you emails). Download or link anywhere.</p>
            <SlideshowMaker />
          </div>
        </Section>
        ...
        <Section className="max-w-7xl mx-auto bg-gradient-to-br from-blue-900/80 to-black rounded-3xl shadow-xl border border-blue-500/30 py-14 px-6 mb-16">
          ...
          <p className="text-blue-100/90 text-center max-w-3xl mx-auto mb-10">Snapshot of planning preferences & trip types. Want to vote? Head to our <Link href="/polls" className="underline">live polls</Link>.</p>
            ...
            {localPolls.map(p => (
              <div key={p.q} className="bg-[#132a55] rounded-2xl p-5 border border-blue-700/40 shadow flex flex-col">
                ...
                <ul className="text-[11px] text-blue-200 space-y-1">
                  {p.a.map(o => <li key={o} className="bg-blue-800/30 rounded px-2 py-1 inline-block">{o}</li>)}
                </ul>
              </div>
            ))}
          </div>
          <div className="flex justify-center mt-10">
            <Link href="/polls" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-10 py-4 rounded-2xl shadow-xl text-lg transition border border-blue-700">More Polls</Link>
          </div>
        </Section>
        ...
        <Section className="max-w-7xl mx-auto bg-gradient-to-br from-[#122a5c] to-[#0f2148] rounded-3xl shadow-xl my-12 py-12 px-6 border border-blue-800/40">
          ...
          <p className="text-blue-100/90 text-center max-w-4xl mx-auto mb-8">Compare capacities, split costs, plan multi‑stop brewery or glacier routes, and check real‑time weather before committing. These tools accelerate confident bookings.</p>
        ...
        <Section className="bg-gradient-to-r from-blue-800 via-blue-900 to-black">
          <div className="max-w-5xl mx-auto text-center py-6">
            ...
            <p className="text-blue-100/90 mb-6">Lock preferred vehicles early—especially for peak cruise Saturdays & holiday aurora windows.</p>
            ...
            <p className="text-[11px] text-blue-300 mt-6">Need multi-day / remote itinerary support? Include all legs + gear notes in the quote form.</p>
          </div>
        </Section>
      </PageLayout>
    );
