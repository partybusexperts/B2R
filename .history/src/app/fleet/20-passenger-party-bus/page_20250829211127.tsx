    ...
    <PageLayout gradientFrom="from-blue-950" gradientVia="via-blue-900" gradientTo="to-black" textColor="text-white">
      ...
      <Section className="max-w-5xl mx-auto bg-gradient-to-br from-blue-900/80 to-black rounded-2xl shadow-xl my-12 py-10 text-white">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-blue-500/40 scrollbar-track-transparent">
          ...
          <SmartImage src="/images/partybus20.jpg" alt="Party Bus 20" className="rounded-2xl shadow-xl w-80 h-56 object-cover object-center border-4 border-blue-700/30" />
        </div>
      </Section>
      ...
      <Section className="max-w-5xl mx-auto my-12 py-10 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-blue-950/70 rounded-xl p-6 flex flex-col items-center">
            <SmartImage src="/images/partybus30.jpg" alt="30 Passenger Party Bus" className="rounded-xl w-40 h-28 object-cover mb-3 border-2 border-blue-700/30" />
          ...
          <div className="bg-blue-950/70 rounded-xl p-6 flex flex-col items-center">
            <SmartImage src="/images/partybus40.jpg" alt="40 Passenger Party Bus" className="rounded-xl w-40 h-28 object-cover mb-3 border-2 border-blue-700/30" />
          ...
          <div className="bg-blue-950/70 rounded-xl p-6 flex flex-col items-center">
            <SmartImage src="/images/limousine.jpg" alt="Limousine" className="rounded-xl w-40 h-28 object-cover mb-3 border-2 border-blue-700/30" />
