...
export default function Home() {
  ...
  {/* Rotating polls grid (3 columns × 4 each) */}
  <Section className="max-w-6xl mx-auto">
    <h2 className="text-3xl font-extrabold text-center text-white mb-6">Community Polls</h2>
    <ClientOnly>
      <HomePolls groups={[{ tag: 'party-bus', label: 'Party Buses' }, { tag: 'fun', label: 'Fun' }, { tag: 'suv', label: 'SUVs' }]} />
    </ClientOnly>
  </Section>
  {/* Party Buses Section */}
<Section className="max-w-6xl mx-auto">
