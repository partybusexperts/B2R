...
// Titles to remove from the canonical tools page (keeps history in the list above)
const REMOVED_TOOL_TITLES = [
  ...
  "Upgrade Option Explorer",
  "Parking Fee Estimator",
  "Driver Profile Viewer",
  "Vehicle Maintenance Log",
  "Feedback Form Creator",
  "Customization Cost Adder",
  "Theme Party Planner",
  "Promo Code Applier",
  "Competitor Price Checker",
  "VIP Access Coordinator",
];

const ALL_TOOLS: Tool[] = [...TOP_TOOLS, ...LEGACY_TOOLS.filter(t => !REMOVED_TOOL_TITLES.includes(t.title))];
