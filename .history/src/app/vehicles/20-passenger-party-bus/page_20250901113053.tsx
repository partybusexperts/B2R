      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        <section className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-4">
            <SmartImage src="https://images.unsplash.com/photo-1523986371872-9d3ba2e2f642?q=80&w=1200&auto=format&fit=crop" alt="20 passenger party bus interior with lights" className="rounded-lg shadow-lg" />
            <div className="grid grid-cols-2 gap-3">
              <SmartImage src="https://images.unsplash.com/photo-1542367597-46c5b2f0a8c1?q=80&w=800&auto=format&fit=crop" alt="party bus exterior" className="rounded-lg" />
              <SmartImage src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?q=80&w=800&auto=format&fit=crop" alt="party bus group photo" className="rounded-lg" />
            </div>
          </div>
        </section>
