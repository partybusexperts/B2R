...
export default function Home() {
  ...
  // Event names and their SEO-optimized image index (must match manifest order)
  const eventNames = [
    ...
    "Bachelor Parties", "Bachelorette Parties", "Brewery Tours", "Girl’s Night Out", "Concerts"
    // Add more if you add more images to manifest
  ];
  // Map event images from manifest (1:1 with eventNames)
  const eventImages = eventOptimizedAll.slice(0, eventNames.length);
