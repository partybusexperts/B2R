...
const eventOptimizedAll = getCategoryImages('eventImages');
...
export default function Home() {
  ...
  // const partyBusImagesList = partyOptimizedAll.map(p => p.original); // unused
  // Event names (homepage order)
  const eventNames = [
    ...
    "Bachelor Parties", "Bachelorette Parties", "Brewery Tours", "Concerts", "Girl’s Night Out",
  ...
  const eventImageMap: Record<string, string> = {
    ...
    "Ski Resort Tours": "ski resort.jpg",
    "New Year’s Eve": "new years eve.jpg",
    "Sporting Events": "sporting events.jpg",
    "Weddings": "weddings.jpg",
    "Prom": "prom.jpg",
    "Graduation": "graduation.jpg",
    "Concerts / Events": "concerts.jpg",
    "Bachelor Parties": "bachelor parties.jpg",
    "Bachelorette Parties": "bachelorette parties.jpg",
    "Brewery Tours": "brewery tours.jpg",
    "Concerts": "concerts.jpg",
    "Girl’s Night Out": "girls nights out.jpg",
    "Guys Night Out": "guys nights out.jpg",
    "Retirement": "retirement parties.jpg",
    "Casinos": "casino tours.jpg",
    "Corporate Parties": "corporate parties.jpg",
    "Birthday Parties": "birthday parties.jpg",
    "Kid’s Parties": "kids parties.jpg",
    "Entertainment Tours": "entertainment tours.jpg",
    "Charter Services": "charter services.jpg",
    "Airport Shuttle": "airport shuttle.jpg",
    "Quinceanera Parties": "quinceanera parties.jpg",
    "Anniversaries": "anniveraries parties.jpg",
    "Special Dinners Out": "dinners out.jpg"
  };

  // Short blurbs for each event card (keeps copy concise and event-specific)
  const eventBlurbMap: Record<string, string> = {
    "Haunted House Tours": "Safe, late-night group transport for spooky nights out.",
    "Thanksgiving Parties": "Door-to-door service for family gatherings and safe rides home.",
    "Christmas Parties": "Festive group transfers with on-time curbside pickup.",
    "Ski Resort Tours": "Gear-friendly shuttles with roomy storage and warm rides.",
    "New Year’s Eve": "Reliable late-night returns and trusted drivers for NYE.",
    "Sporting Events": "Quick drop-offs near arena entrances and smooth post-game exits.",
    "Weddings": "Timely arrivals, elegant vehicles, and attentive chauffeurs.",
    "Prom": "Safe, stylish transport for students and chaperones.",
    "Graduation": "On-time shuttles for ceremonies and post-party plans.",
    "Concerts / Events": "Stress-free arrival and pickup near major venues.",
    "Bachelor Parties": "Party-ready rides with room for luggage and gear.",
    "Bachelorette Parties": "Fun, comfortable transport with flexible pickup windows.",
    "Brewery Tours": "Cooler-friendly trips with planned stops and safe returns.",
    "Concerts": "Group transit tuned for showtime arrivals and exits.",
    "Girl’s Night Out": "Stylish, reliable rides to your favorite spots.",
    "Guys Night Out": "Hassle-free group rides so everyone gets home safe.",
    "Retirement": "Comfortable, celebratory rides for milestone moments.",
    "Casinos": "Convenient casino transfers with secure drop zones.",
    "Corporate Parties": "Professional, punctual transport for company events.",
    "Birthday Parties": "Turnkey group transport so the party goes uninterrupted.",
    "Kid’s Parties": "Family-focused shuttles with extra supervision guidance.",
    "Entertainment Tours": "Curated routes for museums, theaters, and attractions.",
    "Charter Services": "Customizable charters for teams, groups, and outings.",
    "Airport Shuttle": "Timely airport pickups and luggage-friendly service.",
    "Quinceanera Parties": "Celebratory transport with graceful arrival and staging.",
    "Anniversaries": "Romantic, punctual rides for special evenings out.",
    "Special Dinners Out": "Seamless dining transfers with on-time returns.",
  };

  // Build eventImages array by matching eventNames to manifest
  const eventImages = eventNames.map(event =>
    eventOptimizedAll.find(img => img.original.endsWith('/events/' + eventImageMap[event]))
      || eventOptimizedAll[0] // fallback
  );
  ...
  <div className="mt-6 flex flex-wrap md:flex-nowrap gap-2">
    ...
    <div className="relative">
      ...
      <div className="relative group rounded-[24px] overflow-hidden border border-blue-800/40 bg-[#0f2148] shadow-[0_14px_40px_rgba(2,6,23,.55)]">
        <div className="relative">
          <SmartImage
            src="/images/party-buses/18 Passenger Party Bus White Exterior.png"
