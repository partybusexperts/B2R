...
return (
<div className="fixed inset-0 z-[100] flex items-center justify-center" aria-modal="true" role="dialog" aria-labelledby="modal-title" onClick={onClose} >
...
<button onClick={onClose} aria-label="Close" className="shrink-0 rounded-xl px-3 py-1 text-sm font-semibold bg-blue-50 text-blue-700 hover:bg-blue-100" >
Close
</button>
</div>
