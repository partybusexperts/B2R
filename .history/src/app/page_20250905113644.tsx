...
// Minimal placeholder homepage while we stabilize the DB-driven implementation.
export default function Home() {
  return (
    <main className="p-8">
      <h1 className="text-2xl font-bold">Bus2Ride</h1>
      <p className="mt-2 text-gray-600">Homepage placeholder — DB blocks temporarily disabled for rebuild.</p>
    </main>
  );
}
import React from "react";
