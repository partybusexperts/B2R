...
<Section className="max-w-4xl mx-auto bg-gradient-to-br from-blue-900/80 to-black rounded-2xl shadow-xl p-8 border border-blue-400 my-12">
  ...
  <div className="flex gap-6 overflow-x-auto pb-2 hide-scrollbar">
    {[
      ...
      <div
        key={idx}
        className="min-w-[260px] bg-white rounded-xl shadow p-6 flex flex-col items-center border-2 border-blue-400"
      >
        <div className="text-4xl mb-2">{fact.icon}</div>
        <div className="font-semibold text-lg text-blue-900 mb-1 text-center">
          {fact.title}
        </div>
