          ...
          {[
            ...
            <div key={img} className="bg-white rounded-2xl shadow-xl p-4 flex flex-col items-center">
              <a href="/party-buses" className="block w-full group" aria-label="View party bus fleet">
                <SmartImage src={img} alt="Party Bus" className="w-full h-60 object-cover rounded-2xl mb-4 group-hover:opacity-90 transition" sizes="(max-width:640px) 100vw, (max-width:1024px) 50vw, 33vw" />
          ...
          {[
            ...
            <div key={img} className="bg-white rounded-2xl shadow-xl p-4 flex flex-col items-center">
              <a href="/limousines" className="block w-full group" aria-label="View limousine fleet">
                <SmartImage src={img} alt="Limo" className="w-full h-60 object-cover rounded-2xl mb-4 group-hover:opacity-90 transition" sizes="(max-width:640px) 100vw, (max-width:1024px) 50vw, 33vw" />
          ...
          {[
            ...
            <div key={img} className="bg-white rounded-2xl shadow-xl p-5 flex flex-col items-center">
              <a href="/coach-buses" className="block w-full group" aria-label="View coach bus fleet">
                <SmartImage src={img} alt="Coach Bus" className="w-full h-72 object-cover rounded-2xl mb-5 group-hover:opacity-90 transition" sizes="(max-width:640px) 100vw, (max-width:1024px) 50vw, 33vw" />
