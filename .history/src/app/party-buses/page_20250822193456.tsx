...
export default function PartyBusesPage() {
  ...
  return (
    <main className="text-white bg-[#05070f]">
      ...
      {/* ---------- POLLS (search like tools) ---------- */}
      <section className="max-w-6xl mx_auto bg-gradient-to-br from-[#0e1a39] to-[#080e1f] rounded-3xl shadow-xl my-12 py-12 px-6 border border-blue-900/40">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-2 text-white font-serif tracking-tight">
          Party Bus Polls
        </h2>
