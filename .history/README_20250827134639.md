...
The Route Planner + Geocoding tools require this key. Never expose it directly in client code; it is accessed only in server API routes (`/api/geocode`, `/api/plan-route`).
