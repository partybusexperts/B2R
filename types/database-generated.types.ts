    ...
    Tables: {
      ...
      locations_content: {
        Row: {
          ...
          comfort_checklist: Json | null;
          complete_guide: string | null;
          created_at: string;
          extra_notes: Json | null;
          fleet_type: string | null;
          header: Json | null;
          how_to_book: Json | null;
          id: string;
          location_slug: string;
          planning_checklist: string | null;
          state_planning_guide: Json | null;
        ...
        Relationships: [
          {
            foreignKeyName: "locations_content_location_slug_fkey";
