...
-- supabase/migrations/0005_seed_contact_hero.sql
-- Idempotent upsert of a contact hero row for the contact page

INSERT INTO content_points (page_slug, key, data)
VALUES (
  'contact',
  'contact-hero',
  json_build_object(
    'title', 'Contact Us — Live',
    'subtitle', 'Fast quotes, real humans, zero spam. Call, email, or use the form below.',
    'phone_display', '(888) 535-2566',
    'phone_tel', '8885352566',
    'email', 'info@bus2ride.com',
    'primary_cta', json_build_object('label','Instant Live Quote','href','/quote#instant'),
    'secondary_cta', json_build_object('label','Email Us','href','mailto:info@bus2ride.com'),
    'tertiary_cta', json_build_object('label','Call (888) 535-2566','href','tel:8885352566'),
