...
export function VehicleDetail({ vehicle }: { vehicle: VehicleData }) {
  ...
  return (
    <section className="bg-background">
      {/* 1. Header / Title Area */}
      <div className="bg-primary py-12 md:py-20 text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <Badge
            variant="outline"
            className="mb-4 border-primary-foreground/30 text-primary-foreground
              hover:bg-primary-foreground/10 uppercase tracking-widest"
          >
            {vehicle?.type?.replace("-", " ") || "Vehicle"}
          </Badge>
          <h1
          ...
          >
            The ultimate {vehicle?.type?.replace("-", " ") || "Vehicle"}{" "}
