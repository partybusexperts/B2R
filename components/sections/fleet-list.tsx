...
export function FleetList({ vehicles, title }: FleetListProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0B1938]">
      ...
      {/* --- Vehicle Grid (Refactored) --- */}
      <div>
        {filteredVehicles.length > 0 ? (
          /* 1. Pass the entire filtered array to vehicles prop
            2. We don't pass 'title' so FleetPreview only renders the Grid, not the header
          */
          <FleetPreview vehicles={filteredVehicles} showNavigation={false} />
        ) : (
