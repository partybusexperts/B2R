    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          data-[state=open]:slide-in-from-top-[48%] fixed top-[50%] left-[50%]
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring
              data-[state=open]:bg-white data-[state=open]:text-white absolute
              ...
              [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 text-white"
          >
            <XIcon />
