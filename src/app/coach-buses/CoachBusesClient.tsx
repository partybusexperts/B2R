...
/* ---------------- Events ---------------- */
// Use the canonical event names from the main Events page. Removed fleet-specific
// entries like "Team Travel", "Shuttle Circuits" and "Church Groups" and
// replaced them with event types that appear on /events (better SEO and UX).
...
const EVENTS_IMAGES_MAP: Record<string, string> = {
  ...
  Prom: "/images/events/prom.jpg",
  "Sporting Events": "/images/events/sporting events.jpg",
  "Concerts / Events": "/images/events/concerts.jpg",
  "Graduation Celebration": "/images/events/graduation.jpg",
  "Corporate Parties": "/images/events/corporate parties.jpg",
  ...
  "Airport Shuttle": "/images/events/airport shuttle.jpg",
  "Entertainment Tours": "/images/events/entertainment tours.jpg",
  "Retirement Celebrations": "/images/events/retirement parties.jpg",
};
      ...
      <StructuredData
        ...
        data={{
          ...
          mainEntity: catalogCoaches.slice(0,12).map(v => ({
            ...
            additionalProperty: v.capacityMax ? [{ '@type': 'PropertyValue', name: 'Capacity', value: v.capacityMax }] : undefined,
