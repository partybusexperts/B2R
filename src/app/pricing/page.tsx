						...
						<Section className="max-w-6xl mx-auto bg-gradient-to-br from-blue-900/80 to-black rounded-3xl shadow-xl my-12 py-12 px-6 border border-blue-500/30">
								...
								<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
									{[
										...
										{ name: "Rachel L.", text: "We had the best time ever!! Darrius was our driver and he was so fun and amazing!! It was for our bachelor/bachelorette weekend and he made it so much fun!!! I would recommend them 100%!!!" },
										{ name: "Becky B.", text: "Sonny can take your event to the next level with his beautiful limos and sedans making you feel like a movie star! Highly recommend his service!" },
										{ name: "George S.", text: "Top of the line chauffer and limo service." },
										{ name: "Teresa S.", text: "What a memorable night for our students at Faith Christian School prom. Rick was an excellent and safe driver, providing top notch customer service, and was prompt with timing. The owner was great to work with and has the best prices and customer service. We will definitely choose them for next year's prom. Amazing experience!" },
										{ name: "Carleigh S.", text: "We have used them twice. One for a 16 year old birthday party and once just for transportation for a large group. Always on time. Drivers were wonderful. Will be using again in the future." },
										{ name: "Lindsay J.", text: "Used for a wedding and very satisfied! Drivers were very communicative. Jerry was friendly and easy to work with. Would recommend." },
										{ name: "Leah K.", text: "We rented a party bus for my daughter’s 10th birthday and I cannot say enough good things about our experience! Communicating with Jerry and our driver Jim was easy and direct. They kept me informed with arrival time and were prompt when I asked a last minute question. They accommodated all of our requests - made the party the BEST experience and party EVER! Our driver, Jim, was laid back, polite, and happily took the girls whenever they wanted to ride! This is THE BEST service ever and I would HIGHLY recommend using them. You talk directly to the owner and the price can not be beat!!! Thank you Accent for making all our 10th birthday dreams come true!!! You guys are the BEST!" },
										{ name: "Angela F.", text: "We booked the party bus for prom. The driver was on time and friendly. The bus was clean and comfortable. The kids had a wonderful time and made great memories! I highly recommend them and will use them for future events." },
										{ name: "Kaley H.", text: "We had the best evening last Saturday! Our driver was on time and courteous, delivered us to our destination both ways, and even got the things we left on the bus back to us." },
										...
										<div key={i} className="relative bg-gradient-to-br from-blue-800/80 via-blue-900/80 to-black/80 border-2 border-blue-700/40 rounded-2xl shadow-xl p-7 flex flex-col gap-3 hover:scale-[1.025] transition-transform group overflow-hidden">
											...
											<div className="text-blue-50 text-base leading-relaxed font-medium drop-shadow-lg relative z-10">{review.text}</div>
											<svg className="absolute right-0 bottom-0 opacity-10 w-24 h-24 pointer-events-none group-hover:opacity-20 transition" viewBox="0 0 100 100"><circle cx="50" cy="50" r="48" fill="url(#grad)" /><defs><radialGradient id="grad"><stop offset="0%" stopColor="#3b82f6" /><stop offset="100%" stopColor="#1e293b" /></radialGradient></defs></svg>
										</div>
									))}
								</div>
								<div className="flex justify-center mt-10">
