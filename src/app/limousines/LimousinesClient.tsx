...
// Pulled dynamically from Supabase-backed fleet data via server wrapper
...
export default function LimousinesClient({ vehicles }: Props) {
  ...
  // Polls are served by HomePolls; local pollSearch/filter removed to keep UI canonical
  ...
  {/* HERO removed - page now begins at fleet */}
      ...
      <section className="max-w-6xl mx-auto bg-gradient-to-br from-[#122a5c] to-[#0f2148] rounded-3xl shadow-xl my-12 py-12 px-6 border border-blue-800/30">
        ...
        <div className="w-full flex justify-center mb-8">
          {/* HomePolls handles search & canonical UI */}
          <HomePolls groups={[{ tag: 'limousines', label: 'Limousines' }]} pickSize={50} visiblePerGroup={6} />
        </div>
      </section>
