// app/city/anchorage/vehicle/limousine/page.jsx
...
export async function generateMetadata() {
  ...
  const title = `${city?.name || 'Anchorage'} Limousine Service — Bus2Ride`;
  const description = `Private limousines in ${city?.name || 'Anchorage'}. Compare vehicles, photos, and get a quote.`;
...
export default async function AnchorageLimousine() {
