...
export default function PartyBusesPage() {
  ...
  return (
    <main className="text-white">
      ...
      {/* Tools Section */}
      <section className="w-full bg-gradient-to-br from-blue-950 via-blue-900 to-black py-20 md:py-24">
      ...
      {/* Simple CTA anchor target for #book */}
      <section
        id="book"
        className="max-w-2xl mx-auto text-center bg-gradient-to-br from-blue-900/80 to-black rounded-2xl shadow-xl my-12 py-10"
      >
